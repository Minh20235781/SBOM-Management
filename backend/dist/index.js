...
exports.app.use('/api/systems', systemRoutes_1.default);
exports.app.use('/api/projects', projectSbomRoutes_1.default);
exports.app.use('/api/sbom', sbomSnapshotRoutes_1.default);
exports.app.use('/api', cicdRoutes_1.default);
exports.app.use('/api/validation-scenarios', validationScenarioRoutes_1.default);
